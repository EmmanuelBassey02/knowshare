  ...
  return (
       ...
       <div className="bg-gradient-to-r from-black via-fuchsia-950 to-black pb-[60px]  h-fit md:pt-[50px] pt-[30px] px-[4vw]">
            ...
            <section class="h-fit pt-[35px] px-[1vw] md:px-[5vw] ">
                <p class="font-mono text-neutral-200 md:text-[36px] text-[22px]">....SOCIALIZE, LEARN, GROW, EARN,
                    ...
                    {/* SECTION TWO  */}
            <section className='px-[3vw]  bg-black h-fit pb-[80px] pt-[90px] text-center' >
                    {/* <h1 className='text-[50px] text-black font-bold'>Discover a World of ideas and connection</h1><br /> */}
                    ...
                    <div className='md:h-[400px] h-[180px]  md:w-[70vw] w-[94vw] md:mt-[60px]  mt-[25px] m-auto  '>
                        <img src={sectiontwo} alt="" className='h-[100%] w-[100vw]'/>
                    </div>
            </section>


                      {/* carousel  */}
            <section className='bg-black px-[4vw] text-center py-[50px] border-2 border-white  h-[480px]'> 
                 {/* <h1 className='text-[40px] m-auto text-white'>Carousel section</h1> */}
                 {/* <Carousel></Carousel> */}
    ...
    {/* <Carousel>
      ...
      <img src="https://flowbite.com/docs/images/carousel/carousel-5.svg" alt="..." />
            ...
            <section class="bg-fuchsia-50  px-[4vw] h-fit py-[50px] pt-[60px]">
        <h1 class="text-black text-[34px] font-bold ">What's different about KnowShare?</h1> <br/><br/><br/>

        <div  class="py-[12px] h-fit flex flex-wrap gap-[10px] justify-center align-middle">
            <div class="shadow border-2 mb-4  border-black w-[280px] h-[380px] p-[10px] rounded-[15px]">
            ...
            <div class="shadow border-2 mb-4  border-black w-[280px] h-[380px] p-[10px] rounded-[15px]">
                ...
                <p class="text-[12px] font-bold mt-[10px]">Explore the library &nbsp; <i class="fas fa-arrow-right"></i></p>
                    ...
                    {/* EDUCATION HUB  */}
                    <section className='px-[5vw] h-fit pt-[100px] text-center bg-black'>
                            <h1 className='md:text-[55px] text-[26px] text-white font-bold'>KnowShare's Education Hub</h1><br /> <br />
                            <img src={eduimg} alt="" className='m-auto'/> <br /><br />
                            <p className='md:w-[70vw] w-[85vw] m-auto  text-neutral-300 md:text-[22px] text-[15px] font-bold'>Embark on an enriching journey of knowledge discovery, where curiosity knows no bounds, and every click opens doors to a world of insights, collaborations, and transformative learning experience -  
         ...
         <section className='px-[3vw] pt-[50px] pb-[80px] bg-black h-fit mt-[-100px] flex flex-wrap gap-[20px] justify-between align-middle'>

                            {/* Accordion */}
            <section class="text-center w-[500px] border-2 h-[400px] border-red-500">
                    {/* <Accordion/> */}
            </section>
                    ...
                    {/* Carousel  */}
                    <div className='border-2 border-solid border-green-500 text-center w-[600px] h-[330px]'>
                       <p className='font-bold text-[28px] text-white '>Carousel</p>
                    </div>
        </section>
                ...
                <section className="px-[5vw] pt-[85px] pb-[50px]  font-bold text-center bg-fuchisa-200 bg-fuchsia-100 h-fit">
                        ...
                        <div className='flex flex-wrap justify-center align-middle gap-[60px] mt-[60px] rounded-[20px] px-[15px] shadow'>
                   ...
                   <section className="px-[5vw] pt-[35px] pb-[50px] md:pb-[110px]  font-bold text-center bg-fuchisa-200 bg-fuchsia-100 h-fit">
                     ...
                     <div className='flex flex-wrap justify-center align-middle px-[15px] pb-[20px] gap-[30px] mt-[60px] bg-neutral-900 rounded-[20px]'>
                        ...
                        {/* WHAT OUR USERS SAY  */}
      <section className="flex flex-wrap justify-center gap-[20px] text-center px-[3vw] md:px-[4vw] bg-fuchsia-100 pt-[150px] pb-[20px]  md:pb-[140px]"><br />
                    <div className="border-2 border-solid mb-[110px] border-gray-700 w-[370px] md:h-[285px] h-[270px] rounded-[8px] bg-fuchsia-950">
                            <img src={img9} alt="image" className="bg-black w-[170px]  h-[170px] rounded-[50%] relative md:left-[160px] left-[100px] top-[-90px]"/>

                        <div className="md:w-[350px] w-[280px] md:h-[150px] h-fit m-auto mt-[-55px] bg-fuchsia-100 p-[8px]">
                            <p className="font-bold text-[17px]">"What sets KnowShare apart is the genuine sense of community. Not only having followers, but having a community that listens."</p>
                        </div>
                    </div>


                    <div className="border-2 border-solid mb-[110px] border-gray-700 w-[370px] md:h-[285px] h-[270px] rounded-[8px] bg-fuchsia-950">
                            <img src={imgg1} alt="image" className="w-[170px]  h-[170px] rounded-[50%] relative md:left-[160px] left-[100px] top-[-90px]"/>

                        <div className="md:w-[350px] w-[280px] md:h-[150px] h-fit m-auto mt-[-55px] bg-fuchsia-100 p-[8px]">
                            <p className="font-bold text-[17px]">"Discovering this platform has been a game-changer for me! I've never experienced such an engaging blend of socializing and knowledge-sharing. "</p>
                        </div>
                    </div>


                    <div className="border-2 border-solid mb-[110px] border-gray-700 w-[370px] md:h-[285px] h-[270px] rounded-[8px] bg-fuchsia-950">
                            <img src={img6} alt="image" className="w-[170px]  h-[170px] rounded-[50%] relative md:left-[160px] left-[100px] top-[-90px]"/>

                        <div className="md:w-[350px] w-[280px] md:h-[150px] h-fit m-auto mt-[-55px] bg-fuchsia-100 p-[8px]">
                            <p className="font-bold text-[17px]">"It's not just a social hub; it's a dynamic space where minds converge, and each interaction becomes an opportunity for personal growth."</p>
                        </div>
                    </div>
        </section>
                   ...
                   <section className='h-fit py-[20px]   md:py-[35px] text-center bg-gradient-to-r from-black via-fuchsia-950 to-black pt-[35px] px-[1vw] md:px-[5vw] '>
                    ...
                    <section className='bg-neutral-900 text-center text-neutral-500'>
                        <p>see  &nbsp; 
                            <Link to="/homepage" className='hover:underline hover:text-fuchsia-500'> mainHomepage</Link></p>
                    </section>
                    ...
                    <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                        ...
                        <div class="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                            <a href="#" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                                <svg class="w-4 h-4 text-neutral-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 8 19">
