  ...
  return (
    ...
    {/* <Carousel>
      ...
      <section className="flex flex-wrap justify-center gap-[20px] text-center px-[3vw] md:px-[4vw] bg-fuchsia-100 pt-[150px] pb-[20px]  md:pb-[140px]"><br />
                    <div class="border-2 border-solid mb-[110px] border-gray-700 w-[370px] md:h-[285px] h-[270px] rounded-[8px] bg-fuchsia-950">
                            <img src={img9} alt="image" class="bg-black w-[170px]  h-[170px] rounded-[50%] relative md:left-[160px] left-[100px] top-[-90px]"/>

                        <div class="md:w-[350px] w-[280px] md:h-[150px] h-fit m-auto mt-[-55px] bg-fuchsia-100 p-[8px]">
                            <p class="font-bold text-[17px]">"What sets KnowShare apart is the genuine sense of community. Not only having followers, but having a community that listens."</p>
                        </div>
                    </div>


                    <div class="border-2 border-solid mb-[110px] border-gray-700 w-[370px] md:h-[285px] h-[270px] rounded-[8px] bg-fuchsia-950">
                            <img src={imgg1} alt="image" class="w-[170px]  h-[170px] rounded-[50%] relative md:left-[160px] left-[100px] top-[-90px]"/>

                        <div class="md:w-[350px] w-[280px] md:h-[150px] h-fit m-auto mt-[-55px] bg-fuchsia-100 p-[8px]">
                            <p class="font-bold text-[17px]">"Discovering this platform has been a game-changer for me! I've never experienced such an engaging blend of socializing and knowledge-sharing. "</p>
                        </div>
                    </div>


                    <div class="border-2 border-solid mb-[110px] border-gray-700 w-[370px] md:h-[285px] h-[270px] rounded-[8px] bg-fuchsia-950">
                            <img src={img6} alt="image" class="w-[170px]  h-[170px] rounded-[50%] relative md:left-[160px] left-[100px] top-[-90px]"/>

                        <div class="md:w-[350px] w-[280px] md:h-[150px] h-fit m-auto mt-[-55px] bg-fuchsia-100 p-[8px]">
                            <p class="font-bold text-[17px]">"It's not just a social hub; it's a dynamic space where minds converge, and each interaction becomes an opportunity for personal growth."</p>
                        </div>
                    </div>
        </section>
                   ...
                   <section className='h-fit py-[20px]   md:py-[35px] text-center bg-gradient-to-r from-black via-fuchsia-950 to-black pt-[35px] px-[1vw] md:px-[5vw] '>
                    ...
                    <section className='bg-neutral-900 text-center text-neutral-500'>
                        <p>see  &nbsp; 
                            <Link to="/mainhomepage" className='hover:underline hover:text-fuchsia-500'> mainHomepage</Link></p>
                    </section>
